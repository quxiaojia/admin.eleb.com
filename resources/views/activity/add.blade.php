...
@section('contents')
    @include('vendor.ueditor.assets')
            <div class="page-header">
                <h1 style="margin-left: 30%;font-size: 50px"><small>新增活动</small></h1>
            </div>
            @include('layouts._errors')
            <form method="post" action="{{route('activity.store')}}" enctype="multipart/form-data" style="margin-left: 30%">
                <div style="margin-bottom: 20px">
                    <div class="input-group ">
                        <span class="input-group-addon" id="basic-addon2" style="width: 100px;">活动名称:</span>
                        <input type="text" name="title" class="form-control"  placeholder="请输入您要添加的活动名称" aria-describedby="sizing-addon2" style="width: 200%;background-color:  #FFFFCC">
                    </div>
                </div>
                ...
                <div style="margin-bottom: 20px">
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1" style="width: 100px;">活动开始时间: </span>
                ...
                <div style="margin-bottom: 20px">
                    <div class="input-group">
                        <span class="input-group-addon" id="basic-addon1" style="width: 100px;">活动结束时间: </span>
