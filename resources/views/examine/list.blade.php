    ...
    <table  class="table table-hover">
        ...
        <tr>
          ...
          {{--  创建一个快捷指向storage/app/public/face(位置在public/storage)     php artisan storage:link--}}
            <td style="width: 100px">@if($classified->img)<img class="img-circle" style="width: 80px;height: 80px;border-radius: 90px" src="{{\Illuminate\Support\Facades\Storage::url($classified->img)}}"/>@endif</td>
